...
|--|--|--|
| **CRUD en PostgreSQL:** Realización de operaciones de base de datos desde Node-RED o Python. | | Se implementó un CRUD con SQLite, donde, con ayuda de Node-RED, se creó una interfaz sencilla para interactuar con las tablas de la base de datos. |
